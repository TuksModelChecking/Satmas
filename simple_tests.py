...
def test_a0():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/A0false.txt"
    ) is False, "A0 Should Not Be Solvable"


def test_a1():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/A1true.txt"
    ) is True, "A1 Should Not Be Solvable"


def test_b0():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/B0false.txt"
    ) is False, "B0 Should Not Be Solvable"


def test_b1():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/B1false.txt"
    ) is False, "B1 Should Not Be Solvable"


def test_b2():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/B2true.txt"
    ) is True, "B2 Should Be Solvable"


def test_b3():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/B3true.txt"
    ) is True, "B3 Should Be Solvable"


def test_c1():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/C1true.txt"
    ) is True, "C1 Should Be Solvable"


def test_c2():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/C2true.txt"
    ) is True, "C2 Should Be Solvable"


def test_d1():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/D1false.txt"
    ) is False, "D1 Should Not Be Solvable"


def test_d2():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/D2false.txt"
    ) is False, "D2 Should Not Be Solvable"


def test_e1():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/E1false.txt"
    ) is False, "E1 Should Not Be Solvable"


def test_e2():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/E2true.txt"
    ) is True, "E2 Should Be Solvable"


def test_f1():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/F1false.txt"
    ) is False, "F1 Should Not Be Solvable"


def test_f2():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/F2false.txt"
    ) is False, "F2 Should Not Be Solvable"


def test_f3():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/F3false.txt"
    ) is False, "F3 Should Not Be Solvable"


def test_f4():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/F4false.txt"
    ) is False, "F4 Should Not Be Solvable"


def test_j1():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/J1false.txt"
    ) is False, "J1 Should Not Be Solvable"


def test_j2():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/J2true.txt"
    ) is True, "J2 Should Be Solvable"


def test_j3():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/J3true.txt"
    ) is True, "J3 Should Be Solvable"


def test_k1():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/K1false.txt"
    ) is False, "K1 Should Not Be Solvable"


def test_k2():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/K2false.txt"
    ) is False, "K1 Should Not Be Solvable"


def test_k3():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/K3false.txt"
    ) is False, "K3 Should Not Be Solvable"


def test_k4():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/suite1/K4true.txt"
    ) is True, "K4 Should Be Solvable"


def test_email():
    assert logic_encoding.main(
        f"{INITIAL_PATH}/problem.yml"
